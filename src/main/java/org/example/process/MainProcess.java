...
public class MainProcess extends Thread {
    private final List<DirectoryData> directoryDataList;
    private final DirectoryChooserTool chooserTool;

    public MainProcess(List<DirectoryData> directoryDataList, DirectoryChooserTool chooserTool) {
    ...
    @Override
    public void run() {
        for (DirectoryData directoryData : directoryDataList) {
            // 每批處理的數量
